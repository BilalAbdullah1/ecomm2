...
namespace Ecomm.Migrations
{
    ...
    [Migration("20240722205036_udpchange")]
    partial class udpchange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecomm.Models.ExhibitionSubmissions", b =>
                {
                    ...
                    b.ToTable("ExhibtionSubmission");
                });

            modelBuilder.Entity("Ecomm.Models.Exhibitions", b =>
                {
                    b.Property<int>("ExbId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExbId"));

                    b.Property<string>("ExbDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExbTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecomm.Models.ExhibitionSubmissions", b =>
                {
                    b.HasOne("Ecomm.Models.Exhibitions", "Exhibition")
                        .WithMany()
                        .HasForeignKey("ExhibitionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ecomm.Models.Submissions", "Submission")
                        .WithMany()
